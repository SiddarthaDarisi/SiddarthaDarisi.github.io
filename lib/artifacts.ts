...
export const artifacts: Artifact[] = [
  {
    ...
    process: [
      ...
      "Fine-tuned Llama 3.2 3B with QLoRA (4-bit NF4, LoRA r=16), writing a chunked cross-entropy trainer to fit 8 GB VRAM; a Llama 3.1 8B fine-tune trained alongside as the quality ceiling.",
